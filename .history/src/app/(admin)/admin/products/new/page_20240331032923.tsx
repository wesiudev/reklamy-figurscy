          ...
          <div className="grid grid-cols-2 mx-auto mt-12">
            <div className="flex flex-col items-center">
              ...
              <div className="">
                <button
                  className={`${
                    !productInfo.text2Title && "add_content_btn"
                  } mt-12`}
                  onClick={() =>
                    setCurrentInput({ type: "text", title: "text2Title" })
                  }
                >
                  {!productInfo.text2Title
                    ? "Tytuł tekstu 1"
                    : productInfo.text2Title}
                </button>
              </div>
              ...
              <div className="">
                <button
                  onClick={() =>
                    setCurrentInput({ type: "html", title: "text2Desc" })
                  }
                  className={`${
                    !productInfo.text2Desc && "add_content_btn"
                  } mt-4`}
                >
                  {!productInfo.text2Desc
                    ? "Opis tekstu 1"
                    : productInfo.text2Desc}
                </button>
              </div>
              ...
              <div className="">
                <button
                  className={`${
                    !productInfo.text3Title && "add_content_btn"
                  } mt-4`}
                  onClick={() =>
                    setCurrentInput({ type: "text", title: "text3Title" })
                  }
                >
                  Tytuł tekstu 2 <br />
              ...
              <div className="">
                <button
                  ...
                  onClick={() =>
                    setCurrentInput({ type: "html", title: "text3Desc" })
                  }
                >
