          ...
          <div className="w-full flex items-center justify-between mt-3 relative">
            <div className="flex flex-row items-center">
              <Link
                ...
                className="hover:bg-green-500 duration-200 rounded-l-3xl py-0.5 px-3 text-zinc-800 hover:text-white"
              >
                606 136 200
              </Link>
              ...
              <Link
                ...
                className="hover:bg-green-500 duration-200 rounded-r-3xl py-0.5 px-3 text-zinc-800 hover:text-white"
              >
                606 136 400
              </Link>
            </div>
