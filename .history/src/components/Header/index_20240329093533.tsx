    ...
    <>
      <div className="py-4 z-[500] sticky top-0 left-0 bg-white border-gray-300 border-b flex flex-row items-center w-full justify-between px-4 md:px-8 lg:px-12 xl:px-20 2xl:px-32">
        ...
        <div className="flex flex-col items-end justify-center ">
          ...
          <div className="bg-red-500 w-full flex items-center justify-between mt-3 relative">
            ...
            <div
              className={`${
                currentMailVisible % 2 === 0 ? "opacity-100" : "opacity-0"
              } absolute right-0 top-0`}
            >
              piotr@reklamy-figurscy.com.pl
            </div>
            <div
              className={`${
                currentMailVisible % 2 === 1 ? "opacity-100" : "opacity-0"
              } absolute right-0 top-0`}
            >
              wioletta@reklamy-figurscy.com.pl
            </div>
          </div>
        </div>
      </div>
