        ...
        <div className="flex flex-col items-end justify-center ">
          ...
          <div className="w-full flex items-center justify-between mt-3 relative">
            <div className="flex flex-row items-center">
              <div className="hover:bg-green-500 duration-200 rounded-l-3xl py-0.5 px-3 text-zinc-800 hover:text-white">
                606 136 200
              </div>
              <div className="flex items-center justify-center rounded-full bg-green-500 w-8 h-8 -mx-2">
                <FaPhoneAlt className="text-white" />
              </div>
              <div className="hover:bg-green-500 duration-200 rounded-r-3xl py-0.5 px-3 text-zinc-800 hover:text-white">
                606 136 400
              </div>
            </div>
            <Link
