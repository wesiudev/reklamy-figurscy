      ...
      <div className="py-4 z-[500] sticky top-0 left-0 bg-white border-gray-300 border-b flex flex-row items-center w-full justify-between px-4 md:px-8 lg:px-12 xl:px-20 2xl:px-32">
        ...
        <div className="flex flex-row items-center space-x-3 font-semibold shadow-black relative">
          ...
          <Link href="tel:564624985" title="Zadzwoń" className="relative group">
            ...
            <div
              className={`w-full h-full justify-center absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 flex flex-row items-center group-hover:opacity-100 group-hover:scale-x-100 scale-x-0 opacity-0 duration-200 delay-200`}
            >
