    ...
    <>
      <div className="py-4 z-[500] sticky top-0 left-0 bg-white border-gray-300 border-b flex flex-row items-center w-full justify-between px-4 md:px-8 lg:px-12 xl:px-20 2xl:px-32">
        ...
        <div className="flex flex-col items-end justify-center ">
          ...
          <div className="w-full flex items-center justify-between mt-3 relative text-white">
            <div className="flex flex-row items-center">
              <div className="hover:bg-green-500 duration-200 rounded-l-3xl py-0.5 px-3">
                606 136 200
              </div>
              <div className="flex items-center justify-center  rounded-full bg-green-500 w-8 h-8 -mx-2">
                <FaPhoneAlt />
              </div>
              <div className="hover:bg-green-500 duration-200 rounded-r-3xl py-0.5 px-3">
                606 136 400
              </div>
            </div>
            <Link
