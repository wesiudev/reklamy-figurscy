    ...
    <>
      <div className="py-4 z-[500] sticky top-0 left-0 bg-white border-gray-300 border-b flex flex-row items-center w-full justify-between px-4 md:px-8 lg:px-12 xl:px-20 2xl:px-32">
        ...
        <div className="flex flex-col items-end justify-center">
          ...
          <div className="bg-red-500 w-full flex items-center justify-between mt-3">
            <div className="flex flex-row items-center">
              606 136 200{" "}
              <div className="mx-3 rounded-full bg-green-500 p-3"></div>
              <FaPhoneAlt className="text-white" /> 606 136 400
            </div>
            <div className=""> 72141752</div>
          </div>
        </div>
      </div>
    </>
